...
class Genre(models.Model):
    """
    Modelo que representa un género literario (p. ej. ciencia ficción, poesía,
     etc.).
    """
    name = models.CharField(
        max_length=200,
        help_text="Ingrese el nombre del género (ej. Ficción, Poesía, etc.)")
...
class Book(models.Model):
    ...
    # ForeignKey, ya que un libro tiene un solo autor, pero el mismo autor
    ...
    isbn = models.CharField(
        'ISBN', max_length=13, help_text='13 Caracteres'
        '<a href="https://www.isbn-international.org/content/what-isbn">'
        'ISBN number</a>')

    genre = models.ManyToManyField(
        Genre, help_text="Seleccione un genero para este libro")
    # ManyToManyField, porque un género puede contener muchos libros y
    # un libro puede cubrir varios géneros.
...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(primary_key=True,
                          default=uuid.uuid4, help_text="ID único para este"
                          " libro particular en toda la biblioteca")
